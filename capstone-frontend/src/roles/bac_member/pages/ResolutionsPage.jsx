  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Review resolution drafts, co-sign status, and committee decisions awaiting your signature.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
          <p className="text-[11px] uppercase tracking-wide text-gray-500">Co-sign Queue</p>
          <p className={`text-2xl font-bold mt-2 ${pending.length > 0 ? 'text-amber-600' : 'text-gray-900'}`}>{pending.length}</p>
        </div>
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
          <p className="text-[11px] uppercase tracking-wide text-gray-500">Signed</p>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100">
          <h2 className="text-base font-semibold text-gray-900">Resolution Co-sign Queue</h2>
        </div>
        {loading ? (
                  ...
                  <div className="px-5 pb-4 bg-gray-50 border-t border-gray-100">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm pt-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">{Array.isArray(res.signatories) ? res.signatories.length : 0} of {res.min_signatures_required || '—'} required</p>
                      </div>
                      <div>
